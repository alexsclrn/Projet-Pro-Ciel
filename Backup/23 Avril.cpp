...
void loop() {
  ...
  client.println("<button class=\"button boutton-cligno\">"
    "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 143 286' width='32' height='32' fill='black'>"
  ...
  client.println("<button class=\"button boutton-cligno\">"
    ...
    "</button>");
  client.println("<button class=\"button boutton-cligno\">"
    "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 429 286' width='32' height='32' fill='black'>"
